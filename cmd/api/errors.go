...
func (app *application) notFoundRequestResponse(w http.ResponseWriter, r *http.Request, err error) {
...
func (app *application) unauthorizedBasicErrorResponse(w http.ResponseWriter, r *http.Request, err error) {
	app.logger.PrintInfo("unauthorized basic error", map[string]string{"method": r.Method, "path": r.URL.Path, "err": err.Error()})
